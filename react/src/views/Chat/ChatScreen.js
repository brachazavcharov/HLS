...
class ChatScreen extends React.Component {
    ...
    // scrollToBottom = () => {
    //     const scrollHeight = this.scrollDiv ? this.scrollDiv.current.scrollHeight : 0;
    //     const height = this.scrollDiv.current.clientHeight;
    //     const maxScrollTop = scrollHeight>0?scrollHeight - height:0;
